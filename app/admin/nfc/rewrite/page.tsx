    ...
    <main className="zmk-admin-page px-4 py-5">
      <div className="mx-auto max-w-3xl">
        <div className="mb-5 flex items-center justify-between gap-3">
          <div>
            <p className="zmk-eyebrow text-[10px]">NFC WRITE</p>
            <h1 className="mt-1 text-2xl font-bold">NFC書き込み</h1>
          </div>
          <Link href="/admin/nfc" className="zmk-admin-link min-h-10 px-4 py-2 text-sm">戻る</Link>
        </div>
        <div className="zmk-admin-card grid gap-5 p-5 md:grid-cols-[1fr_260px]">
          <div>
            <dl className="grid gap-4 text-sm">
              ...
              <div><dt className="font-bold">書き込むURL</dt><dd className="zmk-admin-code mt-1 break-all p-3 font-bold">{canonicalUrl}</dd></div>
            </dl>
          ...
          <div className="zmk-admin-panel p-3 text-center">
