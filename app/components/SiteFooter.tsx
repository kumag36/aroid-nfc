  ...
  return (
    <footer className="border-t border-[#2c6a4b]/10 bg-[#fffef8] px-5 py-10 text-[#143326] [font-family:var(--font-zamakuri)] dark:border-[#d9ffd8]/12 dark:bg-[#07110c] dark:text-[#f7fbf1]">
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1fr_auto] md:items-end">
        <div>
          <p className="text-xs font-semibold tracking-[0.28em] text-[#b89558]">
        ...
        <nav className="flex flex-wrap gap-x-5 gap-y-3 text-[11px] font-semibold tracking-[0.16em] text-[#315244]/72 dark:text-[#d9ffd8]/72">
          {legalLinks.map((item) => (
