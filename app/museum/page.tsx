          ...
          <div className="hidden lg:block">
            <div className="relative ml-auto max-w-[520px] border border-[#2c6a4b]/12 bg-white/72 p-6 shadow-[0_32px_120px_rgba(0,0,0,0.28)] backdrop-blur-sm">
              <div className="mb-7 flex items-center justify-between gap-5 border-b border-[#2c6a4b]/10 pb-5">
                ...
                <span className="text-[11px] tracking-[0.2em] text-[#315244]/55">ADMIN ONLY</span>
              </div>
              <div className="grid grid-cols-[0.74fr_1fr] gap-4">
                <div className="aspect-[3/4] border border-[#d9ffd8]/16 bg-[#d9ffd8]/10" />
                <div className="grid gap-4">
                  <div className="border border-[#2c6a4b]/10 bg-[#fffef8]/52 p-4">
                    <p className="mb-3 text-[10px] font-semibold tracking-[0.24em] text-[#315244]/48">
                      EXHIBITION NOTE
                    </p>
                    <p className="text-xl font-medium leading-snug text-[#143326]">
                      作品を増やすほど、展示室は深くなる。
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    {['MANGA', 'ART', 'LOG', 'ROOM'].map((label) => (
                      <div
                        key={label}
                        className="border border-[#2c6a4b]/10 bg-[#fffaf0]/6 py-5 text-center text-[10px] font-semibold tracking-[0.2em] text-[#143326]/62"
                      >
                        {label}
                      </div>
                    ))}
